...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Upload Results via Excel File</h5>
                ...
                <div class="col-6">
                    ...
                    @enderror
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="{{ route('results.upload') }}" class="btn btn-secondary">
                                        <i class="bi bi-arrow-left"></i> Back to Manual Upload
                                    </a>
                                </div>
                            </form>
                        </div>
...
$(document).ready(function() {
    ...
    // Setup for Template Download Form (Step 1)
    setupClassArmSelect('#template_class', '#template_classarm');

    // Setup for Upload Form (Step 2)
    setupClassArmSelect('#class', '#classarm');

    // Handle old values for upload form
    @if(old('class'))
    ...
    // Generate button handler (if exists)
