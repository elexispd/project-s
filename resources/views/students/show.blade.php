                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $student->lga }}</div>
                                </div>
                                ...
                                <livewire:students.student-profile-form :student="$student" />
                                ...
                                <form action="{{ route('students.update', $student->id) }}" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="first_name" type="text" class="form-control" id="fullName"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="middle_name" type="text" class="form-control" id="fullName"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <select name="school_class_id" id="class"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <select name="class_arm_id" id="classarm"
                                                class="form-control @error('class_arm_id') is-invalid @enderror" required>
                                                <option value="{{ $student->class_arm }}" selected>
                                                    {{ $student->classArm->name }}</option>
                                            </select>
                                            @error('class_arm_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="row mb-3">
                                        <label for="Job" class="col-md-4 col-lg-3 col-form-label">Date Of
                                            Birth</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input name="date_of_birth" type="text" class="form-control"
                                                id="Job" value="{{ $student->date_of_birth }}">
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label for="Country" class="col-md-4 col-lg-3 col-form-label">State Of
                                            Origin</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input name="state_of_origin" type="text" class="form-control"
                                                id="Country" value="{{ $student->state_of_orign }}">
                                        </div>
                                    </div>
